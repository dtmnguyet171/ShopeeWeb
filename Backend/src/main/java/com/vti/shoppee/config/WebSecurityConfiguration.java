package com.vti.shoppee.config;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("api/not-authenticated", "/api/v1/account/create", "/api/v1/auth/login-basic-v2"
                        , "/api/v1/auth/login-jwt", "/api/v1/product/search", "/api/v1/account/*").permitAll()
